...
## Data 
_This is where we'll describe the dataset, what we did to it, what other data sets we appended. Next steps:_

* Figure out what data we're going to append, if any
* Structure the data once Juan has spoken with Xue. For an intro, see R for Data Science:
* http://r4ds.had.co.nz/
* Find out from Wasem how to count certified-withdrawn applications.
* For reference: I think the original Kaggle submission that we looked at includes Certified-Withdrawn as Certified; I also think it (and other kaggle submissions) might shortcut our data structuring:
* https://www.kaggle.com/ambarish/eda-us-permanent-visas-with-feature-analysis/code

_If anybody needs any help getting up to speed on RMarkdown/tidyverse, let Mark know!_
...
=======
>>>>>>> e762909fbedf60fdbad8a0377a5e5ca67b4dff4c
## Results 
...
\newpage
## Appendices 
_Next steps: Add in as necesssary. Data dictionary, for starters?_
